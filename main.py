...
class Application:
    ...
    def __init__(self):
        ...
        self.T1.config(text = "Character :", font = ("Times New Roman", 19, "bold"))
        ...
        self.T2.config(text = "Word :", font = ("Times New Roman", 19, "bold"),justify="center")
        ...
        self.T3.config(text = "Sentence:",font = ("Times New Roman", 19, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x = 250, y = 690)
        self.T4.config(text = "Suggestions:", font = ("Times New Roman", 19, "bold"))
    ...
    def video_loop(self):
        ...
        if ret:
            ...
            self.panel3.config(text = self.current_symbol, font = ("Times New Roman", 19))

            self.panel4.config(text = self.word, font = ("Times New Roman", 19))

            self.panel5.config(text = self.str,font = ("Times New Roman", 19))
